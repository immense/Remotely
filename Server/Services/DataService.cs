...
namespace Remotely.Server.Services
{
  ...
  public interface IDataService
  {
    ...
    Task<ApiToken> CreateApiTokenWithOrg(string organizationID, string tokenName, string secretHash);
    ...
    Task<Organization> CreateOrganization(string organizationName);
  ...
  public class DataService : IDataService
  {
    ...
    public async Task<ApiToken> CreateApiToken(string userName, string tokenName, string secretHash)
    {
      ...
      return await CreateApiTokenWithOrg(user.OrganizationID, tokenName, secretHash);
    }
    public async Task<ApiToken> CreateApiTokenWithOrg(string organizationID, string tokenName, string secretHash)
    {
      using var dbContext = _appDbFactory.GetContext();
    ...
    public async Task<Organization> CreateOrganization(string organizationName)
    {
      var org = new Organization()
      {
        OrganizationName = organizationName,
        RelayCode = new string(Guid.NewGuid().ToString().Take(4).ToArray())
      };
