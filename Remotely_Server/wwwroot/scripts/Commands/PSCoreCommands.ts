...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Clear-Content [-Stream <String>] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]

Clear-Content [-Path] <String[]> [-Stream <String>] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Clear-Item [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Clear-ItemProperty [-Name] <String> [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-PassThru] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`WhatIf`, `Shows what would happen if the cmdlet runs. The cmdlet is not run.`, `SwitchParameter`),
        ...
        `Connect-PSSession [-ConnectionUri] <Uri[]> [-AllowRedirection] [-Authentication {Default | Basic | Negotiate | NegotiateWithImplicitCredential | Credssp | Digest | Kerberos}] [-CertificateThumbprint <String>] [-ConfigurationName <String>] [-Confirm] [-Credential <PSCredential>] [-Name <String[]>] [-SessionOption <PSSessionOption>] [-ThrottleLimit <Int32>] [-WhatIf] [<CommonParameters>]
...
new Parameter(`ToSession`, `Specifies the PSSession object to which a remote file is being copied. When you use this parameter, the Path and LiteralPath parameters refer to the local path on the remote machine.`, `PSSession`),
        ...
        `Copy-Item [[-Destination] <String>] [-Container] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-PassThru] [-Recurse] [-Confirm] [-WhatIf] [-UseTransaction] [-FromSession <PSSession>] [-ToSession <PSSession>] [<CommonParameters>]

Copy-Item [-Path] <String[]> [[-Destination] <String>] [-Container] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] [-PassThru] [-Recurse] [-Confirm] [-WhatIf] [-UseTransaction] [-FromSession <PSSession>] [-ToSession <PSSession>] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Copy-ItemProperty [-Destination] <String> [-Name] <String> [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-PassThru] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`WhatIf`, ``, `switch`),
        ...
        `syntaxItem                                                                                                    
----------                                                                                                    
{@{name=Disable-PSRemoting; CommonParameters=True; WorkflowCommonParameters=False; parameter=System.Object[]}}`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`WhatIf`, `Shows what would happen if the cmdlet runs. The cmdlet is not run.`, `SwitchParameter`),
        ...
        `Disable-PSSessionConfiguration [[-Name] <String[]>] [-Confirm] [-Force] [-NoServiceRestart] [-WhatIf] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`WhatIf`, `Shows what would happen if the cmdlet runs. The cmdlet is not run.`, `SwitchParameter`),
        ...
        `Disconnect-PSSession [-Id] <Int32[]> [-Confirm] [-IdleTimeoutSec <Int32>] [-OutputBufferingMode {None | Drop | Block}] [-ThrottleLimit <Int32>] [-WhatIf] [<CommonParameters>]
...
Disconnect-PSSession [-Session] <PSSession[]> [-Confirm] [-IdleTimeoutSec <Int32>] [-OutputBufferingMode {None | Drop | Block}] [-ThrottleLimit <Int32>] [-WhatIf] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`WhatIf`, ``, `switch`),
        ...
        `syntaxItem                                                                                                   
----------                                                                                                   
{@{name=Enable-PSRemoting; CommonParameters=True; WorkflowCommonParameters=False; parameter=System.Object[]}}`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`WhatIf`, `Shows what would happen if the cmdlet runs. The cmdlet is not run.`, `SwitchParameter`),
        ...
        `Enable-PSSessionConfiguration [[-Name] <String[]>] [-Confirm] [-Force] [-NoServiceRestart] [-SecurityDescriptorSddl <String>] [-SkipNetworkProfileCheck] [-WhatIf] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`Verb`, `Specifies an array of command verbs. This cmdlet gets commands, which include cmdlets, functions, and aliases, that have names that include the specified verb. Enter one or more verbs or verb patterns. Wildcard characters are permitted.`, `String[]`),
        ...
        `Gets all commands.`,
        `Get-Command [[-Name] <String[]>] [[-ArgumentList] <Object[]>] [-All] [-CommandType {Alias | Function | Filter | Cmdlet | ExternalScript | Application | Script | Configuration | All}] [-FullyQualifiedModule <ModuleSpecification[]>] [-ListImported] [-Module <String[]>] [-ParameterName <String[]>] [-ParameterType <PSTypeName[]>] [-ShowCommandInfo] [-Syntax] [-TotalCount <Int32>] [<CommonParameters>]
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Get-Item [-Stream <String[]>] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-UseTransaction] [<CommonParameters>]

Get-Item [-Path] <String[]> [-Stream <String[]>] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] [-UseTransaction] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
Get-Module [[-Name] <String[]>] [-FullyQualifiedName <ModuleSpecification[]>] [-ListAvailable] -PSSession <PSSession> [-Refresh] [-PSEdition <String>] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Invoke-Item [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Include <String[]>] -LiteralPath <String[]> [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Move-Item [[-Destination] <String>] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-PassThru] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Move-ItemProperty [-Destination] <String> [-Name] <String[]> [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-PassThru] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Creates a new item.`,
        `New-Item [[-Path] <String[]>] [-Credential <PSCredential>] [-Force] [-ItemType <String>] -Name <String> [-Value <Object>] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`WhatIf`, `Shows what would happen if the cmdlet runs. The cmdlet is not run.`, `SwitchParameter`),
        ...
        `Receive-PSSession [-ConnectionUri] <Uri> [-AllowRedirection] [-Authentication {Default | Basic | Negotiate | NegotiateWithImplicitCredential | Credssp | Digest | Kerberos}] [-CertificateThumbprint <String>] [-ConfigurationName <String>] [-Confirm] [-Credential <PSCredential>] [-JobName <String>] -Name <String> [-OutTarget {Default | Host | Job}] [-SessionOption <PSSessionOption>] [-WhatIf] [<CommonParameters>]
...
Receive-PSSession [-Session] <PSSession> [-Confirm] [-JobName <String>] [-OutTarget {Default | Host | Job}] [-WhatIf] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Remove-Item [-Stream <String[]>] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-Recurse] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]

Remove-Item [-Path] <String[]> [-Stream <String[]>] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] [-Recurse] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Remove-ItemProperty [-Name] <String[]> [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
Remove-PSSession [-Confirm] [-WhatIf] -VMName <String[]> [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
This parameter was introduced in Windows PowerShell 3.0.`, `String`),
        ...
        `Renames a computer.`,
        `Rename-Computer [-NewName] <String> [-ComputerName <String>] [-DomainCredential <PSCredential>] [-Force] [-LocalCredential <PSCredential>] [-PassThru] [-Restart] [-Confirm] [-WhatIf] [-Protocol <String>] [-WsmanAuthentication <String>] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Rename-Item [-NewName] <String> [-Credential <PSCredential>] [-Force] -LiteralPath <String> [-PassThru] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Rename-ItemProperty [-Name] <String> [-NewName] <String> [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String> [-PassThru] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`WhatIf`, `Shows what would happen if the cmdlet runs. The cmdlet is not run.`, `SwitchParameter`),
        ...
        `Restart-Computer [[-ComputerName] <String[]>] [[-Credential] <PSCredential>] [-AsJob] [-Force] [-Impersonation {Default | Anonymous | Identify | Impersonate | Delegate}] [-ThrottleLimit <Int32>] [-DcomAuthentication {Default | None | Connect | Call | Packet | PacketIntegrity | PacketPrivacy | Unchanged}] [-Confirm] [-WhatIf] [<CommonParameters>]
...
This parameter is effective only when the web download uses NTLM, negotiate, or Kerberos-based authentication.`, `SwitchParameter`),
        ...
        `Save-Help [-DestinationPath] <String[]> [[-Module] <PSModuleInfo[]>] [[-UICulture] <CultureInfo[]>] [-Credential <PSCredential>] [-Force] [-FullyQualifiedModule <ModuleSpecification[]>] [-UseDefaultCredentials] [<CommonParameters>]

Save-Help [[-Module] <PSModuleInfo[]>] [[-UICulture] <CultureInfo[]>] [-Credential <PSCredential>] [-Force] [-FullyQualifiedModule <ModuleSpecification[]>] -LiteralPath <String[]> [-UseDefaultCredentials] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Set-Item [[-Value] <Object>] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -LiteralPath <String[]> [-PassThru] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Set-ItemProperty [-Path] <String[]> [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] -InputObject <PSObject> [-PassThru] [-Confirm] [-WhatIf] [-UseTransaction] [<CommonParameters>]
...
new Parameter(`WhatIf`, `Shows what would happen if the cmdlet runs. The cmdlet is not run.`, `SwitchParameter`),
        ...
        `Set-Service [-Description <String>] [-DisplayName <String>] [-InputObject <ServiceController>] [-Credential <PSCredential>] [-PassThru] [-StartupType {Boot | System | Automatic | Manual | Disabled}] [-Status {Running | Stopped | Paused}] [-Confirm] [-WhatIf] [<CommonParameters>]

Set-Service [-Name] <String> [-Description <String>] [-DisplayName <String>] [-Credential <PSCredential>] [-PassThru] [-StartupType {Boot | System | Automatic | Manual | Disabled}] [-Status {Running | Stopped | Paused}] [-Confirm] [-WhatIf] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Split-Path [-Credential <PSCredential>] [-Extension] [-Resolve] [-UseTransaction] [<CommonParameters>]
...
This parameter was introduced in Windows PowerShell 3.0.`, `String`),
        ...
        `Stop-Computer [[-ComputerName] <String[]>] [[-Credential] <PSCredential>] [-AsJob] [-Force] [-Impersonation {Default | Anonymous | Identify | Impersonate | Delegate}] [-ThrottleLimit <Int32>] [-Confirm] [-WhatIf] [-DcomAuthentication <AuthenticationLevel>] [-Protocol <String>] [-WsmanAuthentication <String>] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
Stop-Job [-State] {NotStarted | Running | Completed | Failed | Stopped | Blocked | Suspended | Disconnected | Suspending | Stopping | AtBreakpoint} [-Confirm] [-PassThru] [-WhatIf] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`UseTransaction`, `Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see Includes the command in the active transaction. This parameter is valid only when a transaction is in progress. For more information, see`, `SwitchParameter`),
        ...
        `Test-Path [-OlderThan <DateTime>] [-NewerThan <DateTime>] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Include <String[]>] [-IsValid] -LiteralPath <String[]> [-PathType {Any | Container | Leaf}] [-UseTransaction] [<CommonParameters>]

Test-Path [-Path] <String[]> [-OlderThan <DateTime>] [-NewerThan <DateTime>] [-Credential <PSCredential>] [-Exclude <String[]>] [-Filter <String>] [-Include <String[]>] [-IsValid] [-PathType {Any | Container | Leaf}] [-UseTransaction] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`WhatIf`, `Shows what would happen if the cmdlet runs. The cmdlet is not run.`, `SwitchParameter`),
        ...
        `Unregister-PSSessionConfiguration [-Name] <String> [-Confirm] [-Force] [-NoServiceRestart] [-WhatIf] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
...
new Parameter(`WhatIf`, `Shows what would happen if the cmdlet runs. The cmdlet is not run.`, `SwitchParameter`),
        ...
        `Update-Help [[-Module] <String[]>] [[-UICulture] <CultureInfo[]>] [-Confirm] [-Credential <PSCredential>] [-Force] [-FullyQualifiedModule <ModuleSpecification[]>] [-LiteralPath <String[]>] [-Recurse] [-UseDefaultCredentials] [-WhatIf] [<CommonParameters>]

Update-Help [[-Module] <String[]>] [[-SourcePath] <String[]>] [[-UICulture] <CultureInfo[]>] [-Confirm] [-Credential <PSCredential>] [-Force] [-FullyQualifiedModule <ModuleSpecification[]>] [-Recurse] [-UseDefaultCredentials] [-WhatIf] [<CommonParameters>]`,
        "",
        (parameters, paramDictionary) => {
